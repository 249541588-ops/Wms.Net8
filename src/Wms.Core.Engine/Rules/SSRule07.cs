...
/// <summary>
/// SSRule07 — 单深巷道，按重量上限递增
/// </summary>
public class SSRule07 : LocationAllocationRuleBase
{
    public SSRule07(ILogger<SSRule07> logger) : base(logger) { }

    public override string RuleName => "SSRule07";
...
{excludes}
ORDER BY loc.WeightLimit ASC, loc.HeightLimit ASC";
    }
