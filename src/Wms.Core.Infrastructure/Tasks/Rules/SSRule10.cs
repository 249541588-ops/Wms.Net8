...
/// <summary>
/// SSRule10 — 单深巷道，靠近地面优先
/// </summary>
public class SSRule10 : LocationAllocationRuleBase
{
    public SSRule10(ILogger<SSRule10> logger) : base(logger) { }

    public override string RuleName => "SSRule10";
...
{excludes}
ORDER BY loc.xLevel ASC, loc.WeightLimit ASC";
    }
